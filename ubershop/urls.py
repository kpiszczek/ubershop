...
urlpatterns = patterns('',
    ...
    url(r'^forum/(?P<board_id>\d+)/usun/$', BoardView.delete_board),
    url(r'^forum/(?P<board_id>\d+)/nowy_temat/$', BoardView.create_topic),
    url(r'^forum/(?P<board_id>\d+)/(?P<topic_id>\d+)/$', BoardView.show_topic),
    url(r'^forum/(?P<board_id>\d+)/(?P<topic_id>\d+)/usun/$', BoardView.delete_topic),
    ...
    url(r'^forum/(?P<board_id>\d+)/(?P<topic_id>\d+)/(?P<message_id>\d+)/usun/$', BoardView.delete_message),  
    ...
    url(r'^manager/sklep/(?P<id>\d+)/$', BackendPanel.item_detail),
    url(r'^manager/sklep/(?P<id>\d+)/edytuj/$', BackendPanel.edit_item),
    url(r'^manager/sklep/nowy/$', BackendPanel.add_item),
    url(r'^manager/sklep/(?P<id>\d+)/usun/$', BackendPanel.remove_item),
    ...
    url(r'^manager/grupowe/(?P<id>\d+)/usun/$', BackendPanel.remove_group),
    url(r'^manager/aukcje/$', BackendPanel.auctions_list),
    url(r'^manager/aukcje/(?P<id>\d+)/usun/$', BackendPanel.remove_auction),
    ...
    url(r'^manager/kategorie/(?P<id>\d+)/usun/$', BackendPanel.remove_category),
    url(r'^manager/zamowienia/$', BackendPanel.orders_list),
    url(r'^manager/zamowienia/(?P<id>\d+)/$', BackendPanel.order_detail),#todo
    url(r'^manager/zamowienia/(?P<id>\d+)/usun/$', BackendPanel.remove_order),
